...
@WebServlet("/TSupdate2")
public class TSupdate2 extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getParameterNames() != null) {
            ...
            try {
                ...
                String sql = "update 家庭信息 set sID='" + sID + "',guanxi='" + guanxi + "',name1='" +name1+ "',number1='" + number1 + "',youbianma='" + youbianma + "',daimahao='" + daimahao + "',pinkun='" + pinkun + "',paichusuo='" + paichusuo + "',sheng='" + sheng + "',shi='" + shi + "',qu='" + qu + "',jiedao='" + jiedao + "'where sID=" + sID;
